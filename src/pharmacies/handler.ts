...
export async function handler(
  ...
  console.log(
    `🔍 [PHARMACIES HANDLER] Path === '/api/pharmacies/reviews': ${path === "/api/pharmacies/reviews"}`,
  );
  ...
  try {
    ...
    if (
      path.startsWith("/api/pharmacies/orders/") &&
    ...
    // --- Rutas de Reseñas ---
    // GET /api/pharmacies/reviews - Listar reseñas del provider (solo para el panel de farmacias)
