...
export const updateDoctorProfileSchema = z.object({
  ...
  profile_picture_url: z.string().optional().nullable(), // base64 o URL — avatar del doctor
...
export const createDiagnosisSchema = z.object({
  diagnosis: z
    .string()
    .min(3, "El diagnóstico es obligatorio (Ej: Faringitis)"),
...
const dayScheduleSchema = z.object({
  ...
  breakStart: z
    ...
    .regex(
      /^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/,
      "Break start time must be in HH:mm format",
    )
    .nullable()
    .optional(),
  breakEnd: z
    ...
    .regex(
      /^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/,
      "Break end time must be in HH:mm format",
    )
    .nullable()
    .optional(),
});
...
export const updateClinicProfileSchema = z.object({
    ...
    z
      .union([
        ...
        z
          ...
          .startsWith(
            "data:image/",
            "Logo must be a valid URL or base64 image",
          ),
      ])
      .optional(),
  ),
  ...
  whatsapp: z
    .preprocess(
      ...
      z
        .string()
        .regex(/^\d{9,10}$/, "WhatsApp must be 9-10 digits")
        .optional(),
    )
    .optional(),
  description: z
...
export const createAppointmentSchema = z.object({
  ...
  specialtyId: z.string().uuid("Specialty ID must be a valid UUID").optional().nullable(),
